...
辅助脚本：[src/dynamic_capture/minidump_process.py](../../src/dynamic_capture/minidump_process.py) — 全内存 minidump 创建工具
...
关键实现：`resolve_index_offset()` — [src/common/xp3_inspect.py:501](../../src/common/xp3_inspect.py#L501)
...
- `load_index()` — [src/common/xp3_inspect.py:523](../../src/common/xp3_inspect.py#L523)
- `parse_entries()` — [src/common/xp3_inspect.py:732](../../src/common/xp3_inspect.py#L732)
...
- `decrypt_hxv4_payload()` — [src/common/xp3_inspect.py:566](../../src/common/xp3_inspect.py#L566)
- `TJSBinaryReader` — [src/common/xp3_inspect.py:582](../../src/common/xp3_inspect.py#L582)
- `parse_hxv4_table()` — [src/common/xp3_inspect.py:645](../../src/common/xp3_inspect.py#L645)
...
- `DripProgram` 类 — [src/common/xp3_inspect.py:173](../../src/common/xp3_inspect.py#L173)
- `_eval_records()` — [src/common/xp3_inspect.py:221](../../src/common/xp3_inspect.py#L221)
- `get64_from_u32()` — [src/common/xp3_inspect.py:299](../../src/common/xp3_inspect.py#L299)
...
- `build_filter_state()` — [src/common/xp3_inspect.py:307](../../src/common/xp3_inspect.py#L307)
- `build_filter_state_map()` — [src/common/xp3_inspect.py:711](../../src/common/xp3_inspect.py#L711)
...
- `FilterRuntimeState` 类 — [src/common/xp3_inspect.py:349](../../src/common/xp3_inspect.py#L349)
- `apply()` — [src/common/xp3_inspect.py:441](../../src/common/xp3_inspect.py#L441)
...
- [src/dynamic_capture/watch_random_plugin_dump.py](../../src/dynamic_capture/watch_random_plugin_dump.py) — 运行时监控与 dump
- [src/dynamic_capture/inspect_manager_dump.py](../../src/dynamic_capture/inspect_manager_dump.py) — FilterManager 状态导出
...
3. **TJS2 字节码解析**：扩展 [src/common/tjs2_inspect.py](../../src/common/tjs2_inspect.py) 以解析 object block 和 constant pool
